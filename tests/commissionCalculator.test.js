const calculateCommission = require('../src/commissionCalculator');
...
test('calculateCommission should return correct commission fees', () => {
	...
	const results = calculateCommission(sampleData);
